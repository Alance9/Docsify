module.exports = {
    ...
    appid: '20231119001884906', // 百度翻译 appid
    key: 'ekTMu2CCHOHEC3eBTkPP', // 百度翻译密钥
    output: 'i18n.data.js', // i18n 输出文件
    indent: 4, // i18n 输出文件缩进
    entry: 'style.md', // 要翻译的入口目录或文件，默认为命令行当前的 src 目录
    ...
    extra: /(\.html)|(\.md)$/, // 默认支持 .vue 和 .js 文件 如果需要支持其他类型的文件，请用正则描述 例如这个示例额外支持 .a .b 文件
}